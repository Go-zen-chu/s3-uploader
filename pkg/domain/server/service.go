...
type Service interface {
	...
	FileUploadHandler(w http.ResponseWriter, r *http.Request)
	ShowUploadedHandler(w http.ResponseWriter, r *http.Request)
}
...
func (s *service) ShowUploadedHandler(w http.ResponseWriter, r *http.Request) {
